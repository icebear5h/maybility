"""Agent-specific Pydantic schemas for LangChain tool inputs"""
...
class UpdateTaskInput(BaseModel):
    """Input schema for updating a task (agent tool)"""
...
class DeleteTaskInput(BaseModel):
    """Input schema for deleting a task (agent tool)"""
    taskId: str = Field(description="Task ID to delete")


class GetTasksInput(BaseModel):
    """Input schema for retrieving tasks (agent tool)"""
...
class CreateEventInput(BaseModel):
    """Input schema for creating a timed event (agent tool)"""
...
class UpdateEventInput(BaseModel):
    """Input schema for updating an event (agent tool)"""
...
class DeleteEventInput(BaseModel):
    """Input schema for deleting an event (agent tool)"""
    eventId: str = Field(description="Event ID to delete")


class GetEventsInput(BaseModel):
    """Input schema for retrieving events (agent tool)"""
...
class AssessInfoInput(BaseModel):
    """Input schema for assessing information sufficiency (agent tool)"""
